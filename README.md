...
This means that it is very easy to port a vector graphics GUI from one language to another, or from a platform to another, or an operating system to another. Not only that but the automatization of this transformations is not at all rocket science and actually not very complex. <a name="graphics_designers_html_anchor"></a>These **transcompilers**, though, may be quite labor intensive depending on the level of details of their implementation.
